...
from src.simulation_client import AsyncSimulationClient, AsyncDatabaseClient
...
class TestPydanticModelsReturn:
    ...
    async def test_simulation_client_returns_pydantic_models(self, unified_client):
    ...
    async def test_pydantic_models_have_validation(self, unified_client):
        ...
        from src.simulation_client.models import CreateSupplierRequest
    ...
    async def test_simulation_results_is_pydantic_model(self, unified_client):
        ...
        if sim_response.simulation.results:
            results = sim_response.simulation.results
            assert_is_pydantic_model(results, "SimulationResults")
    ...
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_nested_pydantic_models(self, unified_client):
